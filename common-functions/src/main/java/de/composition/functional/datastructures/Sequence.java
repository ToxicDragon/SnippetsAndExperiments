...
public abstract class Sequence<E> {
	...
	public <A> A foldRight(Function2<E, A, A> function, A initial) {
		if (isEmpty()) {
			return initial;
		}
		return function.apply(head(), tail().foldRight(function, initial));
	}
	 ...
	 * uses foldRight
	 */
	public Sequence<E> append2(Sequence<E> other) {
		return other.foldRight(prepend(), this);
	}
